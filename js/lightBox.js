...
var metLightbox = {
    ...
    //guardar la imagen que se selecciono
    capturaImagen: function(){
        propLightbox.imagen = this; // aqui se guarda la informacion del elemento donde el SCSS ubica la imagen.
        metLightbox.lightbox(propLightbox.imagen);
    },

    //agregar direccion de la imagen que agregamos al SCSS
    lightbox: function(imagen) {   // imagen = propLightbox.imagen, que es el elemento donde se ubica la imagen
        ...
        propLightbox.modal.innerHTML += '<i class="fa-solid fa-x" id="cerrar_modal"></i>'
